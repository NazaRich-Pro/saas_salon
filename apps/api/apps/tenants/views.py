...
from .serializers import RegisterSalonSerializer, RegisterSoloSerializer, TenantSerializer
...
def auto_login(request):
    ...
    # Generate JWT tokens
    from apps.users.jwt_utils import generate_access_token, generate_refresh_token, parse_device_info
    import uuid
