...
from apps.booking.models import Location, ServiceCategory, Service, Staff, Schedule
...
class OnboardingService:
    ...
    def create_salon(
        ...
        # Build tenant URL
        tenant_url = f"https://{slug}.saas.akylman.online/welcome?token={auto_login_token}"
