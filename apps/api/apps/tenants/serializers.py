...
from .models import Tenant, TenantDomain, Membership
...
class TenantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Tenant
        fields = [
            'id', 'slug', 'name', 'type', 'plan', 'seats', 'status',
            'trial_ends', 'settings', 'created_at', 'updated_at'
        ]
...
class TenantDomainSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TenantDomain
        fields = [
            'id', 'tenant', 'tenant_name', 'domain',
            'verified_at', 'is_verified', 'created_at'
        ]
