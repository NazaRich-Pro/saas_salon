...
class ServiceAdmin(admin.ModelAdmin):
    list_display = ['name', 'tenant', 'category', 'duration_min', 'price_kgs', 'is_active']
...
class StaffAdmin(admin.ModelAdmin):
    list_display = ['name', 'tenant', 'title', 'phone', 'email', 'commission_pct', 'is_active']
    list_filter = ['tenant', 'is_active']
...
class StaffServiceAdmin(admin.ModelAdmin):
    list_display = ['staff', 'service', 'duration_override_min', 'price_override_kgs', 'created_at']
...
class CustomerAdmin(admin.ModelAdmin):
    list_display = ['name', 'tenant', 'phone', 'email', 'total_visits', 'total_spent_kgs', 'loyalty_points', 'is_active']
...
class AppointmentAdmin(admin.ModelAdmin):
    list_display = ['id', 'tenant', 'customer', 'staff', 'start_at', 'status', 'total_price_kgs', 'created_at']
...
class AppointmentServiceAdmin(admin.ModelAdmin):
    list_display = ['appointment', 'service', 'order', 'duration_min', 'price_kgs', 'created_at']
