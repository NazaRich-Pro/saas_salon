...
from apps.tenants.mixins import TenantViewSetMixin, TenantRequiredMixin
from apps.tenants.permissions import IsTenantMember, IsReception, IsTenantAdmin
...
from .serializers import (
    LocationSerializer, ServiceCategorySerializer, ServiceSerializer,
    StaffSerializer, StaffServiceSerializer, ScheduleSerializer,
    CustomerSerializer, AppointmentSerializer, AppointmentCreateSerializer,
    AvailableSlotsSerializer, SlotSerializer, AppointmentStatusSerializer,
    AppointmentRescheduleSerializer
)
from .slot_engine import SlotGenerator
from .services import AppointmentService as AppointmentBusinessService, AppointmentCreationError
...
def create_appointment(request):
    ...
    location_id = str(create_serializer.validated_data['location_id']) if create_serializer.validated_data.get('location_id') else None
