...
class ServiceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'duration_min', 'price_kgs', 'buffer_before_min', 'buffer_after_min',
            'allow_combo', 'is_active', 'created_at'
        ]
        read_only_fields = ['id', 'created_at']
...
class StaffSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Staff
        fields = [
            'id', 'name', 'title', 'phone', 'email', 'bio', 'skills',
            'photo_url', 'commission_pct', 'is_active', 'services_count', 'created_at'
        ]
        read_only_fields = ['id', 'created_at']
...
class StaffServiceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'duration_override_min', 'price_override_kgs', 'created_at'
        ]
        read_only_fields = ['id', 'created_at']
...
class ScheduleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Schedule
        fields = [
            'id', 'staff', 'staff_name', 'rules', 'exceptions',
...
class CustomerSerializer(serializers.ModelSerializer):
    class Meta:
        model = Customer
        fields = [
            'id', 'name', 'phone', 'email', 'date_of_birth', 'notes', 'tags',
            'loyalty_points', 'total_visits', 'total_spent_kgs',
            'is_active', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'loyalty_points', 'total_visits', 'total_spent_kgs', 'created_at', 'updated_at']
...
class AppointmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'staff', 'staff_name', 'location', 'location_name',
            'start_at', 'end_at', 'status', 'source', 'notes', 'internal_notes',
            'total_price_kgs', 'prepaid_kgs', 'discount_kgs',
            'services', 'created_at', 'updated_at'
        ]
        read_only_fields = [
            'id', 'customer_name', 'customer_phone', 'staff_name', 'location_name',
            'services', 'created_at', 'updated_at'
        ]
...
class AppointmentCreateSerializer(serializers.Serializer):
    ...
    source = serializers.ChoiceField(
        choices=['WIDGET', 'ADMIN', 'PHONE', 'WALK_IN', 'API'],
        default='WIDGET'
    )
