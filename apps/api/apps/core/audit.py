...
class AuditService:
    ...
    @staticmethod
    def log_payment(payment_id: str, tenant: Tenant, user: User, amount: float, request: HttpRequest):
        """Log payment action."""
        return AuditService.log(
    ...
    @staticmethod
    def log_refund(payment_id: str, tenant: Tenant, user: User, amount: float, request: HttpRequest):
        """Log refund action."""
        return AuditService.log(
