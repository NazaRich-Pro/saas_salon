...
class TestAppointmentCreation:
    ...
    def test_create_appointment_success(self, authenticated_client, tenant, service, staff, location):
    ...
    def test_create_appointment_in_past(self, authenticated_client, tenant, service, staff, location):
...
class TestDoubleBookingPrevention:
    ...
    def test_double_booking_same_staff(self, authenticated_client, tenant, service, staff, location):
...
class TestAppointmentStatusTransitions:
    ...
    def test_confirm_appointment(self, authenticated_client, tenant, service, staff, location):
    ...
    def test_cancel_appointment(self, authenticated_client, tenant, service, staff, location):
...
class TestAvailableSlots:
    ...
    def test_available_slots(self, authenticated_client, tenant, service, staff, location):
