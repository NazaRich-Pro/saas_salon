...
urlpatterns = [
    ...
    path('reports/export.csv', views_reports.export_csv, name='export_appointments_csv'),
    path('reports/payments-export.csv', views_reports.payments_export_csv, name='export_payments_csv'),
]
