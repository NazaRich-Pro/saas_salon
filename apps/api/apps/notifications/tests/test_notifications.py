...
from apps.booking.models import Customer, Staff, Appointment, Service, ServiceCategory
...
class TestTemplateDefaults:
    ...
    def test_default_templates_exist(self):
        ...
        events = ['WELCOME', 'REMINDER_24H', 'REMINDER_2H', 'FOLLOWUP', 'BIRTHDAY', 'DAILY_DIGEST']
        languages = ['RU', 'KG']
