...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('Loading default notification templates...'))
            ...
            for lang, template_data in languages.items():
                ...
                if existing:
                    if overwrite:
                        ...
                        skipped_count += 1
                        self.stdout.write(f'  - Skipped: {event} / {lang} (already exists)')
                else:
                    # Create new template
                    ...
                    created_count += 1
                    self.stdout.write(self.style.SUCCESS(f'  ✓ Created: {event} / {lang}'))
