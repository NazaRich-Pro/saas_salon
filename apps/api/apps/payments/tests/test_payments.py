...
from apps.booking.models import Service, ServiceCategory, Staff, Customer, Appointment, StaffService, Schedule
from apps.payments.models import Payment, Coupon
from apps.payments.providers import get_provider, ManualCashProvider, StripeStubProvider
...
class TestMarkCashPaid:
    ...
    def test_mark_appointment_as_cash_paid(self, client, tenant, reception_user, appointment):
