...
router.register(r'subscriptions', views.SaaSSubscriptionViewSet, basename='subscription')
...
urlpatterns = [
    ...
    # Stripe (stub)
    path('stripe/create-intent/', views.create_stripe_intent, name='stripe_create_intent'),
    ...
    # Loyalty points
    path('redeem-points/', views_loyalty.redeem_loyalty_points, name='redeem_loyalty_points'),
    path('customer/<uuid:customer_id>/loyalty/', views_loyalty.customer_loyalty_info, name='customer_loyalty_info'),
    
    # Birthday campaigns
    path('birthdays/today/', views_loyalty.todays_birthdays, name='todays_birthdays'),
    path('birthdays/upcoming/', views_loyalty.upcoming_birthdays, name='upcoming_birthdays'),
    
    # Billing
    path('billing/subscription/', views_billing.get_subscription, name='billing_subscription'),
    path('billing/subscription/update-seats/', views_billing.update_seats, name='billing_update_seats'),
    ...
    path('billing/mark-invoice-paid/', views_billing.mark_invoice_paid_endpoint, name='billing_mark_paid'),
