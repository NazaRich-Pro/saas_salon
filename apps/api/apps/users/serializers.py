...
from .totp_utils import verify_totp_code, requires_2fa
...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'email', 'phone', 'is_superadmin', 'twofa_enabled', 'created_at', 'last_login']
...
class DeviceSessionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = DeviceSession
        fields = [
            'id', 'device_id', 'device_name', 'device_type', 'os', 'browser',
            'ip_address', 'country', 'city', 'is_current', 'is_active',
...
class LoginAttemptSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = LoginAttempt
        fields = [
            'id', 'email', 'success', 'failure_reason', 'required_2fa', 'passed_2fa',
            'ip_address', 'device_id', 'attempted_at'
        ]
        read_only_fields = fields
