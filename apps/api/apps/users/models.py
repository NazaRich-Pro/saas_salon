...
class RefreshToken(models.Model):
    ...
    # Device info
    device_id = models.CharField(max_length=255, db_index=True, help_text='Unique device identifier')
    ...
    # Rotation tracking
    previous_token = models.CharField(max_length=255, blank=True, help_text='Previous token in rotation chain')
